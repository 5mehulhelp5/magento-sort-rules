...
3. If you are working with a Magento 2 instance using the Mark Shust Docker setup, run the tests from the Magento project root with:
   ...
   ./bin/clinotty bash -lc '/var/www/html/vendor/bin/phpunit /var/www/html/app/code/StackNuts/SortRules/Test/Unit --debug'
...
- Open issues at: https://github.com/StackNuts/magento-sort-rules/issues
